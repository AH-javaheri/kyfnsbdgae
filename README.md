...
- `ox_lib`
- `oxmysql`
- `apex_inventory` (vault, garage items, the device item)
- `apex_target` (optional) — gives the vault, benches, garage point and medic
...
3. Add the tablet to your `apex_inventory` items.lua:
   ```lua
   ['xs_tablet'] = {
