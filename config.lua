...
-- Item that opens the device. Register it in your apex_inventory items.lua
...
--   vault   — the shared apex_inventory stash container.
...
-- ─────────────────────────────────────────────────────────────
-- Vault / armory
-- Backed by an apex_inventory stash, namespaced per gang. It's a physical
...
-- Item names must match your apex_inventory items.lua exactly.
-- ─────────────────────────────────────────────────────────────
Config.Recipes = {
    {
        id = 'lockpick',
