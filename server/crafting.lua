...
local function hasItems(src, inputs)
    for _, inp in ipairs(inputs) do
        local count = exports.apex_inventory:Search(src, 'count', inp.item)
...
function Crafting.Craft(src, recipeId)
    ...
    for _, inp in ipairs(recipe.inputs) do
        exports.apex_inventory:RemoveItem(src, inp.item, inp.count)
    end
    ...
    exports.apex_inventory:AddItem(src, recipe.output.item, outputCount)
