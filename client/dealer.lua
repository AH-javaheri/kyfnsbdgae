...
-- server says it landed, and gives it a talk interaction (apex_target, or
-- an [E] proximity prompt if apex_target isn't installed). The actual
...
local function spawnDealer(coords, model)
    ...
    if hasTarget() then
        exports.apex_target:addLocalEntity(dealerPed, {
